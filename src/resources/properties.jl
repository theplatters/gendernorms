...
mutable struct GlobalStats
    mean_men::Float64; mean_women::Float64; mean_transfer::Float64
    hist_men::Vector{Float64}; hist_women::Vector{Float64}
    wage_gap::Float64; run_time::Float64
end
